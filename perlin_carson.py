def gen_noise():
  ...
  representation_method = "grayscale" 
  #(Recomended) "grayscale"=grayscale, 
  #"terrain" = terain
  #mispellings will result in grayscale as default
  
  num_rows = 10 #rows and colomns of the noise (intensity)
  screen_size = 500
  ...
  second_noise_intensity = 100
  second_change_amount = 10
  second_smoothing_amount = 1
